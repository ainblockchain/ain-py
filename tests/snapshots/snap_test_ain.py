...
snapshots['TestDatabase::test02Get 1'] = [
    {
        '.rule': {
            'write': 'true'
        },
...
snapshots['TestDatabase::test02GetFunction 1'] = {
    '.function': {
        '0xFUNCTION_HASH': {
            'function_id': '0xFUNCTION_HASH',
            'function_type': 'REST',
...
snapshots['TestDatabase::test02GetOwner 1'] = {
    '.owner': {
        'owners': {
            '*': {
                'branch_owner': True,
...
snapshots['TestDatabase::test02GetRule 1'] = {
    '.rule': {
        'write': 'true'
    },
    'can': {
...
snapshots['TestDatabase::test02GetValue 1'] = {
    'can': {
        'write': -5
    },
    'username': 'test_user'
...
snapshots['TestDatabase::test02GetWithOptions 1'] = None

snapshots['TestDatabase::test02GetWithOptions 2'] = {
    'can': {
        'write': -5
    },
    'username': 'test_user'
...
snapshots['TestDatabase::test02GetWithOptions 3'] = {
    'can': {
        '#state_ph': '0xaf1e44f55da6d7e1aa784dd38372c2c2939570254c6b3f36f80b4878590a9efa'
    },
    'username': 'test_user'
...
snapshots['TestDatabase::test02GetWithOptions 4'] = {
    '#state_ph': '0x3c067fd41205e87fcead2107a0f346881ea7d95249cdbe34d3d72e28e7c9ecd5',
    '#state_ph:username': '0xe9acb84e18d9ec64c66358f53c4fec3945eb065a3e98de907d8d80dc1361c82f',
    'can': {
        '#state_ph': '0xaf1e44f55da6d7e1aa784dd38372c2c2939570254c6b3f36f80b4878590a9efa',
...
snapshots['TestDatabase::test02GetWithOptions 5'] = {
    '#num_children': 2,
    '#num_children:username': 0,
    '#num_parents': 1,
    '#num_parents:username': 1,
...
snapshots['TestDatabase::test04EvalOwner 1'] = {
    'code': 0,
    'matched': {
        'closestOwner': {
            'config': {
...
snapshots['TestDatabase::test04EvalRuleTrue 1'] = {
    'code': 0,
    'matched': {
        'state': {
            'closestRule': {
...
snapshots['TestDatabase::test04MatchFunction 1'] = {
    'matched_config': {
        'config': {
            '0xFUNCTION_HASH': {
                'function_id': '0xFUNCTION_HASH',
...
snapshots['TestDatabase::test04MatchOwner 1'] = {
    'matched_config': {
        'config': {
            'owners': {
                '*': {
...
snapshots['TestDatabase::test04MatchRule 1'] = {
    'state': {
        'matched_config': {
            'config': None,
            'path': '/'
